        ...
        <div class="services__list">
            <div class="row">
                <div class="col-lg col-md-6">
                    <div class="service">
                        <div class="icon">
                            <img src="<?= get_template_directory_uri() ?>/images/icons/service_1.png" alt="Service">
                        </div>
                ...
                <div class="col-lg col-md-6">
                    <div class="service">
                        <div class="icon">
                            <img src="<?= get_template_directory_uri() ?>/images/icons/service_2.png" alt="Service">
                        </div>
                        <div class="content-container">
                ...
                <div class="col-lg col-md-6">
                    <div class="service">
                        <div class="icon">
                            <img src="<?= get_template_directory_uri() ?>/images/icons/service_3.png" alt="Service">
                        </div>
                        <div class="content-container">
                ...
                <div class="col-lg col-md-6">
                    <div class="service">
                        <div class="icon">
                            <img src="<?= get_template_directory_uri() ?>/images/icons/service_4.png" alt="Service">
                        </div>
                        <div class="content-container">

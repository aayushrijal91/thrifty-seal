...
<section class="suburb">
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="suburb-description-card">
                    <div class="sub-heading">Lorem ipsum dolor sit amet</div>
            ...
            <div class="col-lg-6">
                <div class="suburb-description-card">
                    <div class="sub-heading">Consectetur adipiscing elit</div>
            ...
            <div class="col-lg-6">
                <div class="suburb-description-card">
                    <div class="sub-heading">Sed do eiusmod tempor i</div>
            ...
            <div class="col-lg-6">
                <div class="suburb-description-card">
                    <div class="sub-heading">Ut enim ad minim veniam</div>
                    <p>Optio cumque nihil impedit quo minus id quod maxime placeat facere possimus, omnis voluptas assumenda est, omnis dolor repellendus. Temporibus autem quibusdam et aut officiis debitis aut rerum necessitatibus saepe eveniet ut et voluptates repudiandae sint et molestiae non recusandae. Itaque earum rerum hic tenetur a sapiente delectus, ut aut reiciendis voluptatibus maiores alias consequatur aut perferendis doloribus asperiores repellat.</p>
                    <p>Similique sunt in culpa qui officia deserunt mollitia animi, id est laborum et dolorum fuga. Et harum quidem rerum facilis est et expedita distinctio. Nam libero tempore, cum soluta nobis est eligendi.</p>
                </div>
            </div>

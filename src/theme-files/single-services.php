...
<section class="service_inner">
    <div class="container">
        <div class="row justify-content-between align-items-center pb-2">
            <div class="col-lg-6 heroHeading">
                <?= get_field('service_title') ?>
            </div>
            <div class="col-12 col-lg-6 col-xl-auto pt-4 pt-md-5 pt-lg-0">
                            ...
                            <div class="no-hidden-cost">
                                <div class="row no-gutters align-items-center">
                                    ...
                                    <div class="col fw-700 h18 line-height-1 pl-4">
                                        Get a Free QUOTE today<br class="d-none d-xl-block"> with no hidden extras.
                                    </div>
                                </div>
                                <div class="pt-3 h27">
                                    Thrifty Seal will come to your home & give you an on-<br class="d-none d-xl-block">the-spot assessment and price with no hidden extras.
                                </div>
                            </div>
                        </a>
                    </div>
    ...
    <div class="container">
        ...
        ?>
                ...
                background: url(<?= get_sub_field('background_image')['url'] ?>) no-repeat top <?= get_sub_field("right_to_left") ? 'left' : 'right' ?>; background-size: contain;">
                    <div class="d-lg-none">
                        <img src="<?= get_sub_field('background_image')['url'] ?>" class="w-100" alt="">
                    </div>
